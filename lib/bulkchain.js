...
var bisect = function* (guess) {
    ...
    //     return guess;
    // }
    var blockTimeLow = guess.blockTimeLow;
    if(guess.targetTime < blockTimeLow) {
    ...
    // }
        //})
        // .then(function(guess) {
        //     logger.debug({bisect: guess});
        // })
    //)
    //;
};
//     yield Promise.props({
//         highblockcount: guess.highblockcount,
//         lowblockcount: guess.lowblockcount,
//         targettime: guess.targettime,
//     })
//     .then(function(guess) {
//         return ({
//             highblockcount: guess.highblockcount,
//             lowblockcount: guess.lowblockcount,
//             targettime: guess.targettime,
//             midpoint: parseInt((guess.highblockcount - guess.lowblockcount) / 2 , 10) + guess.lowblockcount,
//         })
//     })
//     .then(function(guess) {
//         return ({
...
//             lowblockcount: guess.lowblockcount,
//             targettime: guess.targettime,
//             midpoint:  guess.midpoint,
//             midpointTime: Promise.all(blockCountToTime(guess.midpoint))
//             // midpointTime:
//         })
//     })
//     .catch((err) => {
    ...
    .then(function(startingpoint) {
        ...
        do  {
            ...
            if(feedback.done === false) {
                ret = feedback.value.blockCountWinner;
            }
            console.log('---------------');
        }
