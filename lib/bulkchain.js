...
var dateToBlockCount = function dateToBlockCount( targettime, callback) {
    logger.debug({functionname:'dateToBlockCount', targettime: targettime})
    async.series(
        {
...
var dateRangeToBlockHash = function dateRangeToBlockHash( startdate, enddate, callback) {
    logger.debug({functionname: 'dateRangeToBlockHash', startdate: startdate, enddate: enddate})
    var blockhasharr = []
    async.series({
...
var rawTransactionToTransactionSignature = function rawTransactionToTransactionSignature(rawtransaction, callback) {
    ...
    function shipTransactionSignature (err, transactionsignature){
        ...
        logger.debug({functionname: 'ship_transactionsignature', transactionsignature: transactionsignature})
        process.nextTick(callback(transactionsignature))
    })
}
