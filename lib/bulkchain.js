 ...
 */
var blockCountToBlockHash = async.memoize(slow_blockCountToBlockHash);

module.exports.blockCountToBlockHash = blockCountToBlockHash

var slow_blockHashToBlockHeader = function blockHashToBlockHeader(blockhash, callback) {
 ...
 */
var blockHashToBlockHeader = async.memoize(slow_blockHashToBlockHeader);
 ...
 */
var blockCountToTime = async.memoize(slow_blockCountToTime);
 ...
 */
var dateToBlockCount = async.memoize(slow_dateToBlockCount);
 ...
 */
var txidToRawTransaction = async.memoize(slow_txidToRawTransaction);
    ...
    async.concat(
        ...
        , function getOutput(input, callback) {
            ...
            if ( input.vout !== undefined ) {
                ...
                txidToRawTransaction(input.txid, function (err, outputtransaction) {
                    handleError
