...
var dateRangeToBlockHash = function dateRangeToBlockHash( startdate, enddate, callback) {
    ...
    function(err, blockcountrange) {
        logger.debug({functionname: 'dateRangeToBlockHash', blockcountstart: blockcountrange.blockcountstart, blockcountend: blockcountrange.blockcountend})
            var blockcount = blockcountrange.blockcountstart
            logger.debug({functionname: 'blockcount_range_to_hash', blockcountstart: blockcountrange, blockcountend: blockcountrange.blockcountend })
            async.whilst(
                function check_if_done () {
                ...
                function blockcount_to_blockhash(callback) {
                    logger.debug({functionname: 'blockcount_to_blockhash', blockcount: blockcount})
                    blockCountToBlockHash( blockcount , cb_blockCountToBlockHash)
                    function cb_blockCountToBlockHash (err, blockhash) {
