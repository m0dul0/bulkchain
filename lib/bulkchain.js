    ...
    txidToRawTransaction(txid, function (err, outputtransaction) {
        if(outputtransaction) { 
            async.filter(
                ...
                ,function matchEverythingWTF(inputdetail, callback) {
                    // probably can remove this async.filter logic 
                    callback(inputdetail.n != undefined)
                }
 ...
 */
var txidToOutputArr = async.memoize(slow_txidToOutputArr);
 ...
 * @param {cb_txidToInputDetails~callback} callback - array of inputs
 */
var txidToInputDetail = function ( txid, vout, callback) {
