...
var bisect = function* (params) {
    ...
    yield (Promise.props (
        ...
        .then(function(params) {
            //console.log({bisectresult: params});
            if(params.targetTime <= params.earliestBlockTime) {return params.earliestBlockCount;}
            if(params.targetTime > params.latestBlockTime) {return params.latestBlockCount;}
            // switch (params.targettime)
            // {
            //     case (params.targetTime < params.earliestBlockTime):
            //         console.log('*************** pre genesis *********');
            //         return params.earliestBlockCount;
            //     case params.targetTime < params.latestBlockTime:
            //         console.log('*************** post apocolypse *********');
            //          return params.latestBlockCount;
            //     default:
            //         console.log(params)
            //         console.log('******** need more bisect *********');
            //         return 'o';
            // }
        })
    ));
...
var slow_timeToBlockCount = function* (targetTime) {
    ...
    .then(function(startingpoint) {
        ...
        return bisect(startingpoint).next().value;
    })
    .catch((err) => {
        logger.error(err);
    });
