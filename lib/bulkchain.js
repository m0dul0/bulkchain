...
var txidToRawTransaction = function txidToRawTransaction( txid, callback) {
    ...
    function cb_txidToRawTransaction(err, rawtransaction) {
        handleError
        logger.silly({functionname: 'cb_txidToRawTransaction', rawtransaction: rawtransaction})
...
var rawTransactionToInputDetail = function rawTransactionToInputDetail( rawtransaction, callback ) {
    logger.silly(
        {functionname: 'rawTransactionToInputDetail', rawtransaction_vin:rawtransaction.vin})
    async.concat(
        rawtransaction.vin
        , function getOutput(input, callback) {
            if ( input.vout !== undefined ) {
                logger.silly({functionname: 'getOutput', inputtx: input.txid})
                    ...
                    if(outputtransaction) { 
                        async.filter(
                            ...
                            ,function shipMatchedInOut(inputdetail) {
                                ...
                                inputdetail[0].satoshiSecondsDestroyed = parseInt((inputdetail[0].value * 100000000) + .5) * (rawtransaction.time - outputtransaction.time)
                                callback(err, inputdetail)
                            }
                        )
                    }
                    else {
                        logger.error(rawtransaction.txid)
                        callback(null)
                    }
                }
            }
...
var rawTransactionToTransactionSignature = function rawTransactionToTransactionSignature(rawtransaction, callback) {
    ...
    function shipTransactionSignature (err, transactionsignature){
        ...
        transactionsignature.miningfee = transactionsignature.vin_satoshi_sum - transactionsignature.vout_satoshi_sum
        transactionsignature.vin_satoshi_mean = parseInt((ss.mean(transactionsignature.vin_value_concat) * 100000000) + .5)
        transactionsignature.vin_satoshi_median = parseInt((ss.median(transactionsignature.vin_value_concat) * 100000000) + .5)
        transactionsignature.vin_satoshi_mode = parseInt((ss.mode(transactionsignature.vin_value_concat) * 100000000) + .5)
        transactionsignature.vin_satoshi_sum = parseInt((ss.sum(transactionsignature.vin_value_concat) * 100000000) + .5)
        transactionsignature.vin_satoshi_variance = parseInt((ss.variance(transactionsignature.vin_value_concat) * 100000000) + .5)
        transactionsignature.vin_satoshi_standard_deviation = parseInt((ss.standard_deviation(transactionsignature.vin_value_concat) * 100000000) + .5)
        transactionsignature.vin_satoshi_median_absolute_deviation = parseInt((ss.median_absolute_deviation(transactionsignature.vin_value_concat) * 100000000) + .5)
        transactionsignature.vin_satoshi_geometric_mean = parseInt((ss.geometric_mean(transactionsignature.vin_value_concat) * 100000000) + .5)
        transactionsignature.vin_satoshi_harmonic_mean = parseInt((ss.harmonic_mean(transactionsignature.vin_value_concat) * 100000000) + .5)
        transactionsignature.vin_satoshi_root_mean_square = parseInt((ss.root_mean_square(transactionsignature.vin_value_concat) * 100000000) + .5)
        transactionsignature.vin_satoshi_min = parseInt((ss.min(transactionsignature.vin_value_concat) * 100000000) + .5)
        transactionsignature.vin_satoshi_max = parseInt((ss.max(transactionsignature.vin_value_concat) * 100000000) + .5)
        
        transactionsignature.vout_satoshi_mean = parseInt((ss.mean(transactionsignature.vout_value_concat) * 100000000) + .5)
        transactionsignature.vout_satoshi_median = parseInt((ss.median(transactionsignature.vout_value_concat) * 100000000) + .5)
        transactionsignature.vout_satoshi_mode = parseInt((ss.mode(transactionsignature.vout_value_concat) * 100000000) + .5)
        transactionsignature.vout_satoshi_sum = parseInt((ss.sum(transactionsignature.vout_value_concat) * 100000000) + .5)
        transactionsignature.vout_satoshi_variance = parseInt((ss.variance(transactionsignature.vout_value_concat) * 100000000) + .5)
        transactionsignature.vout_satoshi_standard_deviation = parseInt((ss.standard_deviation(transactionsignature.vout_value_concat) * 100000000) + .5)
        transactionsignature.vout_satoshi_median_absolute_deviation = parseInt((ss.median_absolute_deviation(transactionsignature.vout_value_concat) * 100000000) + .5)
        transactionsignature.vout_satoshi_geometric_mean = parseInt((ss.geometric_mean(transactionsignature.vout_value_concat) * 100000000) + .5)
        transactionsignature.vout_satoshi_harmonic_mean = parseInt((ss.harmonic_mean(transactionsignature.vout_value_concat) * 100000000) + .5)
        transactionsignature.vout_satoshi_root_mean_square = parseInt((ss.root_mean_square(transactionsignature.vout_value_concat) * 100000000) + .5)
        transactionsignature.vout_satoshi_min = parseInt((ss.min(transactionsignature.vout_value_concat) * 100000000) + .5)
        transactionsignature.vout_satoshi_max = parseInt((ss.max(transactionsignature.vout_value_concat) * 100000000) + .5)
...
var dateRangeToTransactionSignature = function dateRangeToTransactionSignature(startdate, enddate, callback) {
    ...
    var q_rawTransactionToTransactionSignature = async.queue(function (task, callback) {
        ...
        logger.silly({functionname: 'q_rawTransactionToTransactionSignature', txid: task.rawtransaction.txid});
        logger.silly({functionname: 'q_rawTransactionToTransactionSignature', rawtransaction: task.rawtransaction})
        rawTransactionToTransactionSignature(task.rawtransaction, function (transactionSignature) {
            logger.silly({functionname: 'q_rawTransactionToTransactionSignature', transactionsignature: transactionSignature} )
    ...
    var q_txidToRawTransaction = async.queue(function (task, callback) {
        if(q_rawTransactionToTransactionSignature.length() > 10) {
