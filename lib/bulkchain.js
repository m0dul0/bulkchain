...
var blockCountToBlockHash = memoize(slow_blockCountToBlockHash, config.memoize );
...
var slow_blockHashToTxid = function(blockhash) {
    return(
        blockHashToBlockHeader(blockhash)
        .then( function(blockheader) {
...
var blockHashToTxid = memoize(slow_blockHashToTxid, config.memoize );
module.exports.blockHashToTxid = blockHashToTxid;
    
var slow_txidToRawTransaction = function (txid) {
    return (client.getRawTransaction( txid, 1 ));
};

var txidToRawTransaction = memoize(slow_txidToRawTransaction, config.memoize );
module.exports.txidToRawTransaction = txidToRawTransaction;

var slow_txidToOutputArr = function (txid) {
    return (
        txidToRawTransaction(txid)
