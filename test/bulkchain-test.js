...
suite('bulkchain:', function(done) {
    ...
    test('rawTransactionToInputItem (magic)', function () {
        ...
        var inputItemZeroN = bulkchain.rawTransactionToInputItem(rawtransaction)
        .then(function(inputitem) {
            return inputitem[0].n;
        })
    ...
    test('rawTransactionToInputItem (block reward aka no inputs)', function () {
        ...
        var inputItemZero = bulkchain.rawTransactionToInputItem(rawtransaction)
